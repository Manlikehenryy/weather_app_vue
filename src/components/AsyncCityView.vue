<template>
  <div class="flex flex-col flex-1 items-center">
    ...
    <div
      class="flex items-center gap-2 py-3 text-white cursor-pointer duration-150 hover:text-red-500"
...
const getWeatherData = async () => {
  try {
    const weatherData = await axios.get(
      `https://api.openweathermap.org/data/2.5/onecall?lat=${route.query.lat}&lon=${route.query.lng}&exclude={part}&appid=486fbf09686f437b13ea4e839cfc55ee&units=imperial`
    );
...
const result = await axios.delete(`https://weather-app-5pix.onrender.com/api/city?id=${route.query.id}`,{
  headers: {
